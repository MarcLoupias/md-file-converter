...
const load_marked_options_1 = require("./io/load-marked-options");
...
const loadMarkedOptions = load_marked_options_1.makeLoadMarkedOptions({ process, require, cliLogger });
